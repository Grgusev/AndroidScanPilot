 ...
 */
package dk.webbook.scanpilot.barcode.ui.camera;
...
import dk.webbook.scanpilot.barcode.BarcodeGraphic;
...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public T getGraphic(int x, int y) {
        synchronized (mLock) {
            for (T graphic : mGraphics) {
                if (graphic instanceof BarcodeGraphic) {
                    Barcode barcode = ((BarcodeGraphic) graphic).getBarcode();
                    if (barcode.getBoundingBox().contains(x, y)){
                        return graphic;
                    }
                }
            }
