...
public class CameraSource {
    ...
    public static class Builder {
         ...
         * associated full picture size, if applicable.  Default: 1600x1024.
         */
    ...
    private static SizePair selectSizePair(Camera camera, int desiredWidth, int desiredHeight) {
        ...
        Log.d(TAG, "Desired Size: " + desiredWidth + " x " + desiredHeight);
        ...
        if (selectedPair != null) {
            Log.d(TAG, "Preview Size: " + selectedPair.previewSize().getWidth() + " x " +
                    selectedPair.previewSize().getHeight());

            Log.d(TAG, "Picture Size: " + selectedPair.pictureSize().getWidth() + " x " +
                    selectedPair.pictureSize().getHeight());
        }
        ...
        for (android.hardware.Camera.Size previewSize : supportedPreviewSizes) {
            ...
            for (android.hardware.Camera.Size pictureSize : supportedPictureSizes) {
                ...
                if (Math.abs(previewAspectRatio - pictureAspectRatio) < ASPECT_RATIO_TOLERANCE) {
                    ...
                    Log.d(TAG, previewSize.width + " x " + previewSize.height + ": " + previewAspectRatio);
                    break;
                }
            }
        }
    ...
    private int[] selectPreviewFpsRange(Camera camera, float desiredPreviewFps) {
        ...
        for (int[] range : previewFpsRangeList) {
            ...
            Log.d(TAG, "FPS: (" + range[Camera.Parameters.PREVIEW_FPS_MIN_INDEX] + ", " +  range[Camera.Parameters.PREVIEW_FPS_MAX_INDEX] + ")");
            if (diff < minDiff) {
        ...
        Log.d(TAG, "FPS Desired: " + desiredPreviewFps);
        if (selectedFpsRange != null) {
            Log.d(TAG, "FPS Selected: (" + selectedFpsRange[Camera.Parameters.PREVIEW_FPS_MIN_INDEX] + ", " + selectedFpsRange[Camera.Parameters.PREVIEW_FPS_MAX_INDEX] + ")");
        }
