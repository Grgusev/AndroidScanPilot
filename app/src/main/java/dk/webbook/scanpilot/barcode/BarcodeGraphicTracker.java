...
class BarcodeGraphicTracker extends Tracker<Barcode> {
    ...
    private BarcodeAutoDetectionListener mBarcodeAutoDetectionListener;
    ...
    public void onNewItem(int id, Barcode item) {
        ...
        if (mBarcodeAutoDetectionListener != null) {
            mBarcodeAutoDetectionListener.onNewBarcodeDetection(item);
        }
    }

    public void setNewBarcodeDetectionListener (BarcodeAutoDetectionListener listener){
    ...
    /**
     * Interface to automatically detect and return barcode
     */
